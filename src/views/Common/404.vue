    ...
    <div class="wscn-http404">
      ...
      <div class="bullshit">
        ...
        <div class="bullshit__info">版权所有
          <a class='link-type' href='//www.lkker.com' target='_blank'>洛客</a>
        </div>
        <div class="bullshit__headline">
          <span>如有任何问题可以联系产品部</span>
          <p class="bullshit_bold">张蕊</p>
          <p class="bullshit_bold">13693393948</p>
          <p class="bullshit_bold">zhangrui-lk@lkkdesign.com</p>
          7*24h竭诚为您服务。
        </div>
        <div class="bullshit__info">请检查您输入的网址是否正确，请点击以下按钮返回主页或者发送错误报告</div>
        <router-link to="/layout/welcome" class="bullshit__return-home">返回首页</router-link>
      </div>
    </div>
  </div>
</template>
